# Django settings for dpatch project.
import os
...
SECRET_KEY = '=etfau3pcmuyl+)sljvy!8*wrhrc7qgo2worr$#az-vum@q%45'
...
WSGI_APPLICATION = 'dpatch.wsgi.application'
